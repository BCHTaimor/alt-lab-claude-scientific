...
- Paper analysis: Which paper, claim, or experiment should be examined, and what level of detail is useful?
- Hypothesis development: What phenotype, model system, perturbation, and competing explanation are in scope?
- Coding: What behavior should change, where does it occur, and how should success be verified?

## Normalized Request

Restate the request in this form before routing it:
...
Once this brief passes the Prompt Readiness Rubric, proceed with the selected workflow. Present the brief when useful, and ask for confirmation only when required for safety, authorization, or a consequential unresolved choice.
