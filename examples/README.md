...
Examples are documentation-level acceptance tests for Alt Lab LLM Agent. They are not executable software tests, but each one supplies a representative request and the routing or response behavior that should result.
...
- [Dual-Mode Operation](dual-mode-operation.md) checks agent-mode delegation, web-mode role simulation, and direct follow-ups.
