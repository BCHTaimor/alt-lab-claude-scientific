...
- [Repository Consultation](repository-consultation.md) checks required consultation before every substantive response after invocation.
- [Question-Strengthening Gate](question-strengthening-gate.md) checks that topic fragments are clarified before deep research, workflow analysis, coding, or tool use.
