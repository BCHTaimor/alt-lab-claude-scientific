...
These acceptance examples demonstrate the expected behavior of the mandatory first-pass workflow. They live in the repository-wide examples area so they can test routing across workflows.
